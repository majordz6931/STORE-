(function () {
  ...
  var T = {
    ar: {
      ...
      paymentsSub: "أضف محافظك هنا — ستظهر للزبناء كخيارات في صفحة إتمام الطلب.",
      payLabel: "اسم الطريقة", payIcon: "أيقونة",
      payNetwork: "الشبكة", payWallet: "عنوان المحفظة",
      payLabelEn: "الاسم بالإنجليزية (اختياري)",
      payQrLabel: "عرض صورة QR", addPayment: "➕ إضافة طريقة",
    ...
    en: {
      ...
      paymentsSub: "Add your wallets here — they appear for customers at checkout.",
      payLabel: "Method name", payIcon: "Icon",
      payNetwork: "Network", payWallet: "Wallet address",
      payLabelEn: "English name (optional)",
      payQrLabel: "Show QR image", addPayment: "➕ Add method",
