(function () {
  ...
  var T = {
    ar: {
      ...
      addCart: "أضف للسلة", added: "✓ تمت الإضافة", buyNow: "💳 اشتري الآن", noProducts: "لا توجد منتجات في هذا القسم بعد.",
      howTitle: "كيف تطلب؟", howSub: "ثلاث خطوات فقط.",
      s1t: "اختر المنتج", s1d: "تصفح المنتجات واختر اللي يناسبك.",
      s2t: "ادفع بطريقة الدفع المتاحة", s2d: "حوّل المبلغ إلى الطريقة المعروضة عند إتمام الطلب.",
      ...
      notes: "ملاحظات", notesPh: "اكتب ملاحظاتك",
      ...
      visitors: "شخص يتصفحون المتجر",
      bought: "اشترى للتو",
      visiting: "يتصفح المتجر الآن 🛍️",
      justNow: "الآن",
      chatHello: "مرحباً، كيف نقدر نساعدك؟",
      chatNamePh: "اسمك للبدء", chatStart: "ابدأ المحادثة",
      chatMsgPh: "اكتب رسالتك...", chatSend: "إرسال",
      liveChat: "الدردشة", noChats: "لا محادثات بعد", reply: "رد", newChat: "بدأ محادثة جديدة",
      ...
      couponValue: "القيمة", coupoonMax: "أقصى استخدام", couponMax: "أقصى استخدام",
      ...
      paymentsSub: "أضف محافظك هنا مع صورة QR — ستظهر للزبناء كخيارات في الدفع.",
      payLabel: "اسم الطريقة",
      payNetwork: "الشبكة",
      payWallet: "عنوان المحفظة",
      payQrLabel: "صورة QR",
      addPayment: "➕ إضافة طريقة دفع",
      noPayments: "لا توجد طرق دفع", removed: "تم الحذف",
      payChoose: "اختر طريقة الدفع",
    ...
    en: {
      ...
      addCart: "Add to cart", added: "✓ Added", buyNow: "💳 Buy now", noProducts: "No products in this category yet.",
      howTitle: "How to order?", howSub: "Only three steps.",
      s1t: "Choose a product", s1d: "Browse products and pick what you need.",
      s2t: "Pay with the shown method", s2d: "Send the amount to the method shown at checkout.",
      ...
      visitors: "people browsing",
      bought: "bought",
      visiting: "is browsing the store 🛍️",
      justNow: "just now",
      chatHello: "Hi, how can we help you?",
      chatNamePh: "Your name to start", chatStart: "Start chat",
      chatMsgPh: "Type a message...", chatSend: "Send",
      liveChat: "Live chat", noChats: "No chats yet", reply: "Reply", newChat: "started a new chat",
      ...
      paymentsSub: "Add your wallets with QR image — shown at checkout.",
      payLabel: "Method name",
      payNetwork: "Network",
      payWallet: "Wallet address",
      payQrLabel: "QR image",
      addPayment: "➕ Add method",
      noPayments: "No payment methods", removed: "Deleted",
      payChoose: "Choose payment method",
